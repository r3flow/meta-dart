...
DART3_APP_BIN_NAME ??= "${PUBSPEC_APPNAME}"
...
DART3_NATIVE_SDK_DIR = "${STAGING_DIR_NATIVE}/opt/dart3-sdk"
...
do_archive_pub_cache[depends] += " \
    dart3-sdk-native:do_populate_sysroot \
...
do_compile() {
    ...
    bbnote "dart3 compile ${DART3_BUILD_ARGS}: Starting"
    dart compile exe ${DART3_BUILD_ARGS} -o ${DART3_APP_OUT_DIR}/${DART3_APP_BIN_NAME} ${DART3_ENTRY_POINT}
    bbnote "dart3 compile ${DART3_ENTRY_POINT}: Completed"
}
...
do_install() {
    ...
    chmod +x ${D}${DART3_APP_INSTALL_DIR}/${DART3_APP_BIN_NAME}
}
