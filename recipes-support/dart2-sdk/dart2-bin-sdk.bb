...
DART2_BIN_SDK_TARGET_ARCH:x86-64 = "x64"
DART2_BIN_SDK_TARGET_ARCH:aarch64 = "arm64"
...
SRC_URI[host.sha256sum] = "${DART2_BIN_SDK_X64_SHA256SUM}"

SRC_URI:class-target = "https://storage.googleapis.com/dart-archive/channels/stable/release/${SRCREV}/sdk/dartsdk-linux-${DART2_BIN_SDK_TARGET_ARCH}-release.zip;downloadfilename=${BPN}-${SRCREV}-${DART2_BIN_SDK_TARGET_ARCH}-target-release.zip;subdir=extracted;name=target"
SRC_URI[target.sha256sum] = "${DART2_BIN_SDK_ARM64_SHA256SUM}"
