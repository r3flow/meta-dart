...
DART3_APP_INSTALL_DIR = "/opt/${PUBSPEC_APPNAME}"

# more options and examples

# optional, you can run a command before
# DART3_PREBUILD_CMD = "dart run build_runner build --delete-conflicting-outputs"
...
# DART3_APP_BIN_NAME = "customBinName"
...
# DART3_APP_INSTALL_DIR variable (see above)
#
# or you can specify a parent path in DART3_APPLICATION_INSTALL_PREFIX
# and your binary will be installed in the 
# DART3_APPLICATION_INSTALL_PREFIX/PUBSPEC_APPNAME directory. this can be useful
# if you have multiple projects and the parent path comes from common configuration.
# if both DART3_APP_INSTALL_DIR and DART3_APPLICATION_INSTALL_PREFIX are defined, the
# former will be used.
